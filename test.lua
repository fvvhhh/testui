...
function Cloudlib.Window(Cloudlib, name, theme)
    ...
    Open.Parent = dogent
    Open.Draggable = true
    Open.Image = "rbxassetid://17798068909"
    ...
    function window.Tab(window, name, icon)
        ...
        function tab.Section(tab, name, TabVal)
            ...
            function section.Button(section, text, callback)
                ...
                ImageFrame.ImageFrame.Parent = BtnModule
                ImageFrame.Size = UDim2.new(0, 50, 0, 50)
                ImageFrame.Position = UDim2.new(0.918383181, 0, 0.5, 0)
                ImageFrame.ImageFrame.BackgroundTransparency = 1
                    ...
                    SetState = function(self, state)
                        ...
                        services.TweenService:Create(
                            ...
                            TweenInfo.new(0.2),
                            {
                                ...
                                BackgroundColor3 = (state and Color3.fromRGB(82, 195, 190) or beijingColor)
                            }
                        ):Play()
